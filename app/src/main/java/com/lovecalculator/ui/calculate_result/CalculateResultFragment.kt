package com.lovecalculator.ui.calculate_result
...
import com.lovecalculator.ui.result_.ResultFragment
...
class CalculateResultFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        loveModel = arguments?.getSerializable(ResultFragment.LOVE_MODEL_RESULT_KEY) as LoveModel?
